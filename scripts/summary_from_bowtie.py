...
with open(file, mode = "r", encoding = "utf-8") as f:
	for line in f:
		if ".fastq.gz" in line:
			if "UMI" in line:
				sample = "UMI" + line.strip().split("_")[0].replace("UMI","") + "_" + line.strip().split("_")[1] + "_" + line.split("_")[2].split(".")[0]
			else:
				sample = line.strip().split("_")[0] + "_" + line.strip().split("_")[1] + "_" + line.split("_")[2].split(".")[0]
